...
/**
 * Thanks to React Bits for the base component!
 * @author DavidHDev
...
export default function MetaBalls({
    ...
    useEffect(() => {
        ...
        const mouseBallPos = {
            x: gl.canvas.width * 0.5 + Math.cos(0.01 * speed) * gl.canvas.width * 0.15,
            y: gl.canvas.height * 0.5 + Math.sin(0.01 * speed) * gl.canvas.height * 0.15,
        };
        ...
        container.addEventListener(
            ...
            (e: PointerEvent) => {
                ...
                pointer.x = (px / rect.width) * gl.canvas.width;
                pointer.y = (1 - py / rect.height) * gl.canvas.height;
            },
            { signal: abortController.signal },
        );
